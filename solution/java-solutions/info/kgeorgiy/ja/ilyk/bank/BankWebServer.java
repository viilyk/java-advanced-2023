...
//            "  <td>{level}</td>" +
    ...
    private final Map<String, App> apps = Map.ofEntries(
            app("Client 1", "java", "-cp", CLASSPATH, "info.kgeorgiy.ja.ilyk.rmi.Client", "name-1", "surname-1", "p1", "a1", "200"),
            app("Client 2", "java", "-cp", CLASSPATH, "info.kgeorgiy.ja.ilyk.rmi.Client", "name-2", "surname-2", "p1", "a2", "400"),
            app("Client 3", "java", "-cp", CLASSPATH, "info.kgeorgiy.ja.ilyk.rmi.Client", "name-1", "surname-1", "p1", "a3", "100"),
            app("Server 1", "java", "-cp", CLASSPATH, "info.kgeorgiy.ja.ilyk.rmi.Server", "8881"),
            app("Server 2", "java", "-cp", CLASSPATH, "info.kgeorgiy.ja.ilyk.rmi.Server", "8882"),
